        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RecurringBookingSeries_MeetingRooms_RoomId",
                        column: x => x.RoomId,
                        principalTable: "MeetingRooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RecurringBookingSeries_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Bookings_RecurringBookingSeries_RecurringSeriesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BookingStatusHistories_Users_ActingUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookingStatusHistories_ActingUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MeetingRooms_Name_Location",
                table: "MeetingRooms",
                columns: new[] { "Name", "Location" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_RecurringBookingSeries_RoomId",
                table: "RecurringBookingSeries",
                column: "RoomId");

            migrationBuilder.CreateIndex(
                name: "IX_RecurringBookingSeries_UserId",
                table: "RecurringBookingSeries",
                column: "UserId");
